/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9f5142c99812fea45a788ce30757b4cb)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	GROQ_API_KEY: string;
	AI_GATEWAY_API_KEY: string;
	EXCALI_AGENT: DurableObjectNamespace<import("./src/index").ExcaliAgent>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GROQ_API_KEY" | "AI_GATEWAY_API_KEY">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f339dd5a4d9fa943be0a82406e9ca83c)
...
interface __BaseEnv_Env {
	...
	ExcaliAgent: DurableObjectNamespace<import("./src/server/index").ExcaliAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "ExcaliAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BRAINTRUST_API_KEY" | "OPENAI_API_KEY" | "TAVILY_API_KEY" | "UPSTASH_VECTOR_REST_URL" | "UPSTASH_VECTOR_REST_TOKEN">> {}
}
